...
import { Main } from "../FoodListIsProcessing/components";
import { withNamespaces } from "react-i18next";
import "../FoodListIsProcessing/FoodListIsProcessing.css";
...
class FoodListIsProcessingBar extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showMessage: false,
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withNamespaces()(FoodListIsProcessingBar));
