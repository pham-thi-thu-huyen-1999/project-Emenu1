...
class VoucherDiscountEdit extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      type: 1,
      listDiscountVoucher: this.props.promoVoucherDetails
    }
  }
  ...
  updateListDiscountVoucher = (data, index) => {
    ...
    newList[index] = { ...listDiscountVoucher[index], ...data }
    this.setState({ listDiscountVoucher: newList })
    this.props.changeVoucherDetails(newList)
  }
    ...
    return (
      <div className="content-field-form">
        <div className="head-form e-flex e-m-bottom-10">
          ...
          <div className="e-flex content-end e-m-right-5 flex">
...
export default VoucherDiscountEdit;