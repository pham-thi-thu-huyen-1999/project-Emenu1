...
export default class PopupSettingBar extends Component {
  constructor(props) {
    super(props);
    //const { t } = this.props;
    this.state = {
      isCheckBox: {
        selectedType: { key: 1, text: props.printAllSameOne }, /* t("settingPrint.printAllSameOne") */
    ...
    return (
      ...
      >
          ...
          <fieldset className="">
            ...
            <div className="e-m-bottom-15 e-m-left-10">
              <RadioList
                name="type"
                dataSource={data}
                onChange={(selectedType, e) => {this.onChange({ selectedType: e });}}
        ...
        <div className="button-action-print e-m-top-15 height-btn-table" style={{ textAlign: "right" }}>
            ...
            <Button onClick={this.props.onSaveChangePrintBar}>
