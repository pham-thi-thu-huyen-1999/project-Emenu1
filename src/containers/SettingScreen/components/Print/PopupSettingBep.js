...
import { Dialog, Button, NumberRange, SelectBox, CheckBox, RadioList } from "../../../../components/common";
...
export default class PopupSettingBep extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isCheckBox: {
        selectedType: { key: 1, text: props.t("settingPrint.printAllSameOne") },
        ...
        isShowDateOrder: props.isCheckBox.isShowDateOrder ? props.isCheckBox.isShowDateOrder : true,
        isShowTableNumber: props.isCheckBox.isShowTableNumber ? props.isCheckBox.isShowTableNumber : true,
        isShowQuantityCustomer: props.isCheckBox.isShowQuantityCustomer ? props.isCheckBox.isShowQuantityCustomer : true,
        //value margin amount
  ...
  render() {
    ...
    const data = [
      { key: 1, text: t("settingPrint.printAllSameOne") },
      { key: 2, text: t("settingPrint.printOne") }
    ];
      ...
      <>
        ...
        >
          ...
          <div className="setting-casher">
                ...
                <div className="e-col-6 device e-m-left-20">
                  ...
                  <div className="select-casher">
                    <SelectBox
                      ...
                      value_copy={isCheckBox && isCheckBox && isCheckBox.devicePrint ? isCheckBox.devicePrint.text : this.state.isCheckBox.devicePrint.text}
            ...
            <fieldset className="">
              <legend className="title-setting-cahser">{t("settingPrint.printMethod")}</legend>
              <div className="e-m-bottom-15 e-m-left-10">
                <RadioList
                  name="type"
                  dataSource={data}
                  onChange={(selectedType, e) => { this.onChange({ selectedType: e }); console.log("radio List", e) }}
                  selected={isCheckBox.selectedType.key}
                />
              </div>
            </fieldset>
              ...
              <div className="e-m-left-10">
                <div className="e-row e-col-12 e-flex item-center">
                  ...
                  <div className="e-col-4 area-name e-flex">
                    <CheckBox
                      name="" //area_id
                      label={t("settingPrint.showDateOrder")} //area_name
                      checked={isCheckBox.isShowDateOrder}
                      onChange={(isShowDateOrder) => this.onChange({ isShowDateOrder })}
                    />
                    <br /> <br />
                  </div>
                </div>
                <div className="e-row e-col-12 e-flex item-center e-m-top-10">
                  <div className="e-col-4 area-name e-flex">
                    <CheckBox
                      name="" //area_id
                      label={t("settingPrint.showQntCustomer")} //area_name
                      checked={isCheckBox.isShowQuantityCustomer}
                      onChange={(isShowQuantityCustomer) => this.onChange({ isShowQuantityCustomer })}
                    />
                    <br /> <br />
                  </div>
                </div>
          ...
          <div className="button-action-print e-m-top-15 height-btn-table" style={{ textAlign: "right" }}>
            ...
            >
              <ReactToPrint
                ...
                pageStyle={pageStyle}
              />
              <CompPrintBillBepBar isCheckBox={isCheckBox} infoAreaSelected={infoAreaSelected} orderDetail={orderDetailTemp} infoPartner={infoPartner} t={t} ref={el => (this.componentRef = el)} />
            </Button>
            <Button onClick={this.props.onSaveChangePrintBep}>
